...
const ProductDetail = (
  {Card, CardBody, CardHeader, Button, prod, cartIt, handleCart, handleDecreaseCart, handleIncreaseCart, handleRemoveFromCart }
  ) => {
  return (
        ...
        <div className='m-4 w-full'>
          ...
          <div className='flex flex-grow gap-6'>
            {/* <div className='flex justify-between items-center middle font-sans center transition-all border-2 w-32 h-10 p-4 text-black bg-white mt-2'>
              ...
              <span className='text-lg'>{ cartIt?.orderables[0] ? cartIt.orderables[0].quantity : 0 }</span>
