...
const Footer = () => {
  return (
    <>
        <footer className="bg-white md:flex md:items-center md:justify-between lg:justify-evenly bottom-0 fixed shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 w-3/4">
