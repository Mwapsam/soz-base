...
const Nav = () => {
  ...
  return (
    <>
            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                ...
                <div className="flex items-center">
                    ...
                    <div className="hidden lg:flex items-center">
                        <svg className="w-10 h-10 p-1 border border-spacing-3 shadow rounded-full  text-gray-700 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        {openNav ? <SideBar openNav={openNav} /> : ''}
    </>
  )
}
