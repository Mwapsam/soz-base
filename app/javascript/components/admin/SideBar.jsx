...
const SideBar = ({openNav, onLogOut}) => {

  return (
    <>
        <aside id="sidebar" className={`${openNav ? 'flex' : 'hidden'} fixed z-20 h-full top-0 left-0 pt-16 lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75`} aria-label="Sidebar">
            ...
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                ...
                <ul className="space-y-2 pb-2">
                    ...
                    <Link to='/products' className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        ...
                        <span className="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">Product</span>
                    </Link>
                    </li>
                    <li>
                    ...
                    <a href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        ...
                        <span onClick={onLogOut} className="ml-3 flex-1 whitespace-nowrap">Logout</span>
                    </a>
                    </li>
                </ul>
                </div>
