  ...
  return (
    <>
        {loading === 'pending' ?
         ...
         (<>
            <h1 className='text-center uppercase font-bold'>All Transactions</h1>
            {transactions?.length !== 0 ? (<div className="flex flex-col mt-8">
                                    ...
                                    {transactions && transactions.map((trans) => (
                                        <tr key={trans.id} className="divide-y divide-gray-100 border-t border-gray-100" >
                                            <td className="p-4 whitespace-nowrap text-sm font-normal text-gray-900">
                                                <span className="font-semibold">{trans?.name?.user_name}</span>
                                            </td>
            ...
            <div className='m-auto'>
                <h4 className='m-auto'>There are no transactions at a moment</h4>
            </div>
            }
          </>)}
    </>
